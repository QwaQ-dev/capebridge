...
contract Bridge_sol {
    ...
    function ChangeMultisigAddress (address _multisig_address) public {
        require(msg.sender == 0x9bB51A70c346d9CfF52b382E85851D78671ACcD0, "not a no-hive");
        multisig_contract = _multisig_address;
    }
